...
// import { dummyDashboardData } from "../../assets/assets"; // Adjust path if needed
    ...
    <>
      <div className="px-4 pt-10 md:px-10 w-full ">
        ...
        <div className="flex flex-wrap items-start gap-6 mb-8 w-full">
            ...
            {data.recentBookings.map((booking, index) => (
              ...
              >
                ...
                <div className="flex items-center gap-2 font-medium">
                  ...
                  <p className="px-3 py-0.5 border border-boderColor rounded-full text-sm">
                    {booking.status}
                  </p>
                </div>
              </div>
          ...
          {/* monthly revenue */}
          <div className="p-4 md:p-6 mb-6 border border-boderColor rounded-md w-full md:max-w-xs">
